...
import questionsTema1 from '../../Utils/Temas/Tema3';
...
const Tema1 = () => {
        ...
        if (event.results[0].isFinal) {
            ...
            if (lowerTranscript === correctAnswer) {
                setCurrentScore(prevScore => {
                    ...
                    localStorage.setItem('tema3', newScore.toString());
                    return newScore;
                });
    ...
    useEffect(() => {
        ...
        if (currentQuestion === +questionsTema1.total) {
            speak(`Calificacion tema 3 es: ${currentScore} puntos`);
            navigate('/');
        }
