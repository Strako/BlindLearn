...
import questionsTema1 from '../../Utils/Temas/Tema5';
...
const Tema1 = () => {
        ...
        if (event.results[0].isFinal) {
            ...
            if (lowerTranscript === correctAnswer) {
                setCurrentScore(prevScore => {
                    ...
                    localStorage.setItem('tema5', newScore.toString());
                    return newScore;
                });
    ...
    useEffect(() => {
        ...
        if (currentQuestion === +questionsTema1.total) {
            speak(`Calificacion tema 5 es: ${currentScore} puntos`);
            navigate('/');
        }
